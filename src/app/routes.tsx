  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-[#dfe9ff] font-sans text-slate-700">
      <header className="relative z-20 shrink-0 border-t-4 border-slate-900 border-b border-slate-200/80 bg-white/78 shadow-[0_2px_14px_rgba(42,64,104,0.12)] backdrop-blur-xl">
        <div className="mx-auto flex h-[80px] max-w-[1480px] items-center justify-between px-6 sm:px-10">
          <Link to="/" className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[30px] font-extrabold leading-none tracking-tight text-[#2761f1]">
                {BRAND_NAME}
              </h1>
          ...
          <button
            ...
            className="rounded-[16px] bg-gradient-to-r from-[#2563eb] to-[#4f35f5] px-6 py-3 text-base font-extrabold text-white shadow-[0_16px_34px_rgba(61,79,226,0.24)] transition hover:translate-y-[-1px] hover:shadow-[0_18px_38px_rgba(61,79,226,0.30)]"
          >
            Đăng nhập / Đăng ký
          </button>
        </div>
      ...
      <main className="relative flex-1 overflow-y-auto bg-[radial-gradient(circle_at_8%_12%,rgba(121,177,255,0.36)_0,transparent_34%),radial-gradient(circle_at_84%_58%,rgba(107,87,255,0.24)_0,transparent_39%),linear-gradient(135deg,#dfeeff_0%,#eef4ff_40%,#dbe3ff_100%)]">
        <section className="mx-auto flex w-full max-w-[1180px] flex-col px-5 pb-10 pt-10 sm:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold tracking-tight text-slate-700 md:text-[38px]">
              Chào mừng đến với {BRAND_NAME}
            </h2>
            <p className="mx-auto mt-4 max-w-[720px] text-lg leading-7 text-slate-500">
              Hệ thống tư vấn sức khỏe ứng dụng AI giúp chẩn đoán sơ bộ dựa trên
              triệu chứng. Hãy bắt đầu bằng cách mô tả tình trạng của bạn.
            </p>
          </div>

          <div className="mx-auto mt-8 grid w-full max-w-[840px] gap-4 md:grid-cols-2">
            {quickPrompts.map((prompt) => (
              <Link
                key={prompt}
                to={`/guest/chat?prompt=${encodeURIComponent(prompt)}`}
                className="group flex h-[60px] items-center rounded-[18px] border border-white/60 bg-white/42 px-6 text-left text-sm font-extrabold text-slate-500 shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] backdrop-blur transition hover:-translate-y-0.5 hover:bg-white/66 hover:text-slate-700"
              >
                <span className="mr-4 text-lg font-bold text-[#4a87ff] transition group-hover:translate-x-0.5">
                  →
                </span>
                {prompt}
              </Link>
          ...
          <section className="mx-auto mt-10 w-full max-w-[1080px]">
            <div className="flex items-start gap-4">
              <div className="mt-1 flex h-[46px] w-[46px] shrink-0 items-center justify-center rounded-full bg-[#dce9ff] text-[#2467ff] shadow-[0_8px_18px_rgba(79,112,177,0.18)]">
                <Bot className="h-5 w-5" />
              </div>
              <div className="min-w-0">
                <div className="max-w-[746px] rounded-[18px] border border-slate-200/70 bg-white/72 px-5 py-4 text-base leading-7 text-slate-700 shadow-[0_14px_28px_rgba(63,78,111,0.13)] backdrop-blur">
                  Xin chào! Tôi là trợ lý ảo y tế của {BRAND_NAME}. Bạn có thể
                  mô tả triệu chứng của mình để tôi hỗ trợ tư vấn sơ bộ, hoặc
                  đăng nhập để đặt lịch khám với các bác sĩ chuyên khoa.
                </div>
                <div className="mt-1.5 flex items-center gap-1.5 pl-1 text-[13px] font-semibold text-slate-400">
            ...
            <div className="mx-auto mt-12 flex items-center gap-3 rounded-[16px] border border-white/75 bg-white/54 p-2 shadow-[0_18px_42px_rgba(70,87,129,0.16)] backdrop-blur max-w-[1020px]">
              <input
                aria-label="Mô tả triệu chứng"
                placeholder="Mô tả triệu chứng hoặc câu hỏi của bạn..."
                className="h-11 min-w-0 flex-1 bg-transparent px-4 text-base text-slate-700 outline-none placeholder:text-slate-500"
              />
              <Link
                to="/guest/chat"
                aria-label="Gửi câu hỏi"
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-[12px] bg-[#7da0ff] text-white shadow-[0_10px_22px_rgba(71,111,231,0.26)] hover:bg-[#5d83f0]"
              >
